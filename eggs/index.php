...
<style>
<?php
$choice = ($current_month + $current_year) % 9;
if ($choice == 0) { ?>
body {
...
<?php } elseif ($choice == 6) { ?>
body {
  background-image: url("data:image/svg+xml,<svg id='patternId' width='100%' height='100%' xmlns='http://www.w3.org/2000/svg'><defs><pattern id='a' patternUnits='userSpaceOnUse' width='36' height='36' patternTransform='scale(1) rotate(0)'><rect width='100%25' height='100%25' fill='%234b5b68'/><path fill='none' stroke='%23474a4d' stroke-linecap='round' stroke-linejoin='round' stroke-width='4' d='M27-12.5h18c1.94 0 3.5 1.561 3.5 3.5V9c0 1.94-1.56 3.5-3.5 3.5H27A3.49 3.49 0 0 1 23.5 9V-9c0-1.938 1.562-3.5 3.5-3.5m-36 0H9c1.94 0 3.5 1.561 3.5 3.5V9c0 1.94-1.56 3.5-3.5 3.5H-9A3.49 3.49 0 0 1-12.5 9V-9c0-1.938 1.562-3.5 3.5-3.5m0 36.001H9c1.94 0 3.5 1.561 3.5 3.5v18c0 1.94-1.56 3.5-3.5 3.5H-9c-1.938 0-3.5-1.56-3.5-3.5v-18c0-1.939 1.562-3.5 3.5-3.5m18-18h18c1.94 0 3.5 1.56 3.5 3.5v18c0 1.939-1.56 3.5-3.5 3.5H9a3.493 3.493 0 0 1-3.5-3.5V9c0-1.94 1.562-3.5 3.5-3.5zm18 18h18c1.94 0 3.5 1.561 3.5 3.5v18c0 1.94-1.56 3.5-3.5 3.5H27c-1.938 0-3.5-1.56-3.5-3.5v-18c0-1.939 1.562-3.5 3.5-3.5'/><path fill='none' stroke='%231988a3' stroke-linecap='round' stroke-linejoin='round' stroke-width='4' d='M12.564 15.389a9.6 9.6 0 0 0 2.824-2.825h5.225a9.6 9.6 0 0 0 2.825 2.825v5.224a9.6 9.6 0 0 0-2.825 2.825h-5.225a9.6 9.6 0 0 0-2.824-2.825v-2.612z'/></pattern></defs><rect width='800%25' height='800%25' fill='url(%23a)'/></svg>");
}
<?php } elseif ($choice == 7) { ?>
body {
